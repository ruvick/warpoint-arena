...
const initPopups = (logging = true, init = true) => new Popup({ logging: logging, init: init });
...
function initSliders() {
    ...
    const modalSlider = new core('.popup-maps__slider', {
			modules: [Navigation, Pagination],
			observer: true,
			observeParents: true,
			slidesPerView: 1,
...
;// CONCATENATED MODULE: ./src/js/files/gsap.js
...
const body = document.querySelector('body')
	...
	function updateMe() {
		...
		degree = radius * 12
		gsapWithCSS.to('.content', 1, { transform: `rotate3d( ${tiltx}, ${tilty}, 0, ${degree}deg )` })

	}
	
	gsapWithCSS.to('.card', { zoom: .98 })
	gsapWithCSS.to('.l_main', { opacity: 1, duration: .1 })
	gsapWithCSS.to('.l2_main', { opacity: 1, left: -10, top: 10, duration: .25, delay: .25 })
	gsapWithCSS.to('.l3_main', { opacity: 1, left: -20, top: 20, duration: .25, delay: .25 })
	gsapWithCSS.to('.card-russia', { opacity: .07, duration: .1 })
	gsapWithCSS.to('.card-logo_w', { opacity: 1, duration: .225 })
	gsapWithCSS.to('.card-chip', { opacity: 1, duration: .225 })
	gsapWithCSS.to('.card-valid', { opacity: 1, zoom: 1, duration: .1, delay: .25 })
	gsapWithCSS.to('.card-number-holder', { opacity: 1, zoom: 1, duration: .1, delay: .25 })
